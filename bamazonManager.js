...
function loadManagerOptions(products) {
    inquirer.prompt({
        type: "list",
        name: "choice",
        choices: ["viewProductsForSale", "viewLowInventory", "addToInventory", "addNewProduct", "quit"],
    ...
    inquirer.prompt([
        {
            type: "input",
            name: "choice",
            message: "What is the ID of the item of the item you would like to add to the inventory?",
